...
| Share Name | Path | Content |
|------------|------|---------|
| **Movies918** | `\\192.168.40.60\Movies918` | Movies |
| **Series918** | `\\192.168.40.60\Series918` | TV shows |
| **Media** | `\\192.168.40.60\Media` | All media combined |

*Note: Sizes vary depending on current UGREEN storage contents. Check available space before adding new files.*
